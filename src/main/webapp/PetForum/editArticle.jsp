...
<!-- This contains the hidden content for inline calls -->
  ...
  var editor = CKEDITOR.replace('content',{
    ...
    $("#pressInput").click(function pressInput(){
    	$("#forumId").val("徵友");//設定徵友文章
    	$("#header").val("【找女朋友】【新北市】曼赤肯帥哥找初戀💘");
    	$("#updatedTime").val(date);
    	let html = "<p>大家好，我是可頌，109/5/5出生，我有粗壯的小短腿、可愛肥美的包子臉，我的爸爸是標準美短，所以我有美短的螺旋蚊，每月都有固定驅蟲，疫苗已經打完，想找初戀女友來場甜甜戀愛，戀愛時可住女友家。<br>"+
    	"照片都是沒有美肌，完全素顏照哦！<br>"+
    	"雙北地區，喜歡我的可以加我媽咪的Line:vernnie</p>"+
    	"<img src='https://34c.cc/yan.php?SN=70a3e5aa24c4e9c9e1ae6ec04d1f2837&SE=3'>"
