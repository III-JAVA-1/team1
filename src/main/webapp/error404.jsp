...
<body>
	...
	<div class="container">
		...
		<div class="row justify-content-center">
			...
			<div class='col-12'>
			<div class="row justify-content-center">
			<div class="h1">您可能點了錯誤的連結或錯誤的網址，請再操作一次試試看</div>
			<div class="h1">如果還有問題請來信告知我們，謝謝</div>
			</div>
			<div class="row justify-content-center">
			<div class="h1">造成您的困擾十分抱歉</div>
			</div>
			<div class="row justify-content-center">
			<button type="button" class="btn btn-primary btn-lg" onclick="goback()" >點我回上頁</button>
			</div>
			</div>	
		</div>
	</div>
