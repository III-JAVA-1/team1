...
<div class="container">
    <div class="row">
        ...
        <article class="col-md-8">
            ...
            <form action="../mom/insertMom" onsubmit="return isCheck()" method="POST" enctype="multipart/form-data"
                  id="myForm">
                <b>
                    ...
                    <div class="col-md-7 picFrame">
                        <div>
                            <div class="picPosition">
                                <input type="file" name="myPic" required=" " id="myPic"/>
                                <!-- 									<div class='row'> -->
                ...
                <div class="form-check formPosition">

                    <button type="submit" class="btn btn-primary" name="submit" onclick="return sendPetMomOrder()">送出</button>
                </div>
            </form>
        </article>
        <div class="col-md-2 bGround"></div>
