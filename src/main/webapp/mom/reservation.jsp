    ...
    <div class="container">
        <div class="row">
            ...
            <article class="col-md-8">
                ...
                <form action="../mom/reservationMom" method="POST" style="margin: auto;" onsubmit="goTime()">
                    <b>
                        <h4>
                            <b>聯絡 <%=getsName%></b>
		...
		$.ajax({
			...
			success : function(data) {
				$.each(data, function(n, m) {
		            ...
		            if(m[3] != null){
		                pet+="<option id='type1'>"+m[3]+"</option>"
                    }
                    if(m[4] != null){
                        pet+="<option id='type2'>"+m[4]+"</option>"
                    }
                    if(m[5] != null){
                        pet+="<option id='type1'>"+m[5]+"</option>"
                    }
                    if(m[6] != null){
                        pet+="<option id='type1'>"+m[6]+"</option>"
                    }
                    $("#petId").append(pet);
